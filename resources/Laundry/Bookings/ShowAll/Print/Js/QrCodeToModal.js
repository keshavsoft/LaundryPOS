...
let AddListeners = () => {
    let jVarLocalPrintButtonClass= document.getElementsByClassName("PrintButtonClass");
   
    for (var i = 0; i < jVarLocalPrintButtonClass.length; i++) {
        jVarLocalPrintButtonClass[i].addEventListener('click', async (inEvent) => {
            ...
            console.log("PrintKey---",jVarInsideQrCodeValue);
